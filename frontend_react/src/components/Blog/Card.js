...
const Card = ({ cardItem }) => {
     const formattedTime = formatDistanceToNow(new Date(cardItem.time), { addSuffix: true, includeSeconds: true });
  ...
  return (
    ...
    <div className="px-6 py-4">
      ...
      <p className="text-gray-700 text-base">
        By {cardItem.author} - {formattedTime}
      </p>
    </div>
    <div className="px-6 py-4">
      <p className="text-gray-700 text-base mb-2">{cardItem.text}</p>
    </div>
